...
public class WheelScroller {
    ...
    private GestureDetector.SimpleOnGestureListener gestureListener = new GestureDetector.SimpleOnGestureListener() { // from class: kankan.wheel.widget.WheelScroller.1
    ...
    private Handler animationHandler = new Handler() { // from class: kankan.wheel.widget.WheelScroller.2
